...
# Önbellek dosyası: EXE içinde sys._MEIPASS, normal çalışmada __file__'ın yanı
def _onbellek_yolu() -> str:
    if hasattr(sys, "_MEIPASS"):
        return os.path.join(sys._MEIPASS, "tkgm", "idler.json")
    return os.path.join(os.path.dirname(__file__), "idler.json")

_ONBELLEK_YOLU = _onbellek_yolu()
